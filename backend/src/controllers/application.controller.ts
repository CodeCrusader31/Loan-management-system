...
// //   try {
// //     const { salarySlipUrl, kycDocumentUrl } = req.body;
// //     const userId = req.user?.userId;

// //     const application = await Application.findOneAndUpdate(
// //       { userId },
// //       { salarySlipUrl, kycDocumentUrl },
...
//     // ✅ Cloudinary URL
//     const salarySlipUrl = (req.file as any).path;
...
//     res
//       .status(200)
//       .json(new ApiResponse(200, application, 'Salary slip uploaded successfully'));
//   } catch (error) {
//     next(error);
//   }
// };
